...
def train(model, X, y, learning_rate=0.01, epochs=1000):
    ...
    for epoch in range(epochs):
        ...
        for sample in range(len(X)):
            ...
            dh1 = np.dot(model.weights2.T, dz2)

            dz1 = dh1 * (z1 > 0)

            dW1 = np.outer(dz1, inputs)
            db1 = dz1
            ...
            model.weights3 -= learning_rate * dW3.reshape(1, 7)
            model.bias3 -= learning_rate * db3
